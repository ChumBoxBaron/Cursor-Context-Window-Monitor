...
# Configure console to be silent
...
class ContextMonitor:
    def __init__(self):
        ...
        self.console = Console(quiet=True)  # Make console silent
    ...
    def update_token_counts(self):
        ...
        self.chat_history_tokens = self.total_tokens * 0.5
    ...
    def monitor(self):
        ...
        with Live(self.generate_status_table(), refresh_per_second=1, console=Console(quiet=True)) as live:
            while True:
...
def main():
    # Use quiet console for all output
    console = Console(quiet=True)
